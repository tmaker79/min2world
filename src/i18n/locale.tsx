...
const ko = {
  ...
  firstTurn: '첫 턴 안내', firstTurnIntro: '세 가지만 기억하고 전투를 시작하세요.', selectUnit: '부대 선택', selectUnitHelp: '지도에서 아군 유닛을 선택하세요.', moveAttack: '이동·공격', moveAttackHelp: '금색 칸은 우클릭으로 이동하고 붉은 대상은 좌클릭해 공격합니다.', produceWin: '병력 생산·승리', produceWinHelp: '도시에서 병력을 생산하고 상대 수도를 점령하세요.', details: '자세히 보기', startGame: '게임 시작',
  helpItems: '도움말 항목', controls: '조작', rules: '규칙', legend: '범례', credits: '크레딧', basicControls: '기본 조작', shortcuts: '단축키', productionEconomy: '생산·경제', victoryConditions: '승리 조건', terrainTiles: '지형 타일',
  creditsBased: '편집·변형된 지형 타일은 다음 자산을 기반으로 합니다.', creditsLicense: '원본 및 변형된 지형 타일은 다음 라이선스로 제공됩니다.',
  controlSelect: '아군 유닛을 선택한 뒤 이동 또는 공격 명령을 선택하세요.', controlMoveAttack: '금색 칸은 이동 가능 범위이며 우클릭으로 이동합니다. 붉은 표시는 공격 가능 대상으로 좌클릭해 공격합니다.', shortcutEnd: '현재 턴 종료', shortcutCancel: '선택 중인 이동·공격·생산·건설 취소',
  quickProduce: '도시에서 군사 유닛을 생산하고 청록색 칸에 배치하세요.', quickCaptureIncome: '중립 농장·광산·대장간으로 이동해 점령하면 턴 수입이 늘어납니다.', economyHelp: '상태바의 자원을 선택하면 수입·유지비·순수입을 확인할 수 있습니다.', captureCapital: '상대 수도를 점령하면 승리합니다.', loseCapital: '내 수도를 빼앗기면 패배합니다.',
  mapLegend: '지도 범례', friendlyCapture: '아군 점령', enemyCapture: '적 점령', friendlyTerritory: '아군 영토', enemyTerritory: '적 영토', contested: '분쟁 지역', reachable: '이동 가능', moveCommand: '이동 명령 또는 우클릭', attackable: '공격 가능', deployable: '생산 배치 가능', cost: '비용 {cost}', costCombat: '비용 {cost} · 전투력 +3', noMove: '이동 불가', siteIncome: '수입 {income}', cityIncome: '수입 {income} · 생산', smithyIncome: '수입 {income} · 군사 생산비 할인',
...
const en: TranslationTable = {
  ...
  firstTurn: 'First Turn Guide', firstTurnIntro: 'Remember these three things and begin the battle.', selectUnit: 'Select a unit', selectUnitHelp: 'Select one of your units on the map.', moveAttack: 'Move & Attack', moveAttackHelp: 'Right-click gold tiles to move and left-click red targets to attack.', produceWin: 'Produce & Win', produceWinHelp: 'Produce troops in your city and capture the enemy capital.', details: 'View Details', startGame: 'Start Game',
  helpItems: 'Help topics', controls: 'Controls', rules: 'Rules', legend: 'Legend', credits: 'Credits', basicControls: 'Basic Controls', shortcuts: 'Shortcuts', productionEconomy: 'Production & Economy', victoryConditions: 'Victory Conditions', terrainTiles: 'Terrain Tiles', controlSelect: 'Select one of your units, then choose the Move or Attack command.', controlMoveAttack: 'Gold tiles are reachable; right-click to move. Red markers are attackable targets; left-click to attack.', shortcutEnd: 'End the current turn', shortcutCancel: 'Cancel the selected move, attack, production, or construction command', quickProduce: 'Produce military units in your city and deploy them on teal tiles.', quickCaptureIncome: 'Capture neutral farms, mines, and blacksmiths to increase turn income.', economyHelp: 'Select resources in the status bar to view income, upkeep, and net income.', captureCapital: 'Capture the enemy capital to win.', loseCapital: 'Lose your capital and you are defeated.',
  creditsBased: 'Edited and adapted terrain tiles are based on the following asset.', creditsLicense: 'Original and adapted terrain tiles are provided under the following license.',
  mapLegend: 'Map Legend', friendlyCapture: 'Friendly control', enemyCapture: 'Enemy control', friendlyTerritory: 'Friendly territory', enemyTerritory: 'Enemy territory', contested: 'Contested territory', reachable: 'Reachable', moveCommand: 'Move command or right-click', attackable: 'Attackable', deployable: 'Production deployment', cost: 'Cost {cost}', costCombat: 'Cost {cost} · Combat +3', noMove: 'Impassable', siteIncome: 'Income {income}', cityIncome: 'Income {income} · Production', smithyIncome: 'Income {income} · Military production discount',
