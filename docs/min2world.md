...
Milestone 16에서는 생산 특화 시설의 지원 관계와 정착지별 생산 거점 한도를 추가한다. Farm·Mine·Blacksmith는 가장 가까운 아군 Town·City에서 통행 가능한 육지 그래프 거리 3 이내에 있어야 하며, Village는 0개, Town은 2개, City는 기본 4개까지 생산 거점을 지원한다. City는 인접 자기 영토 평지에 외곽 지구를 최대 2개 완공해 지구마다 한도를 1개씩, 최대 6개로 늘릴 수 있지만 유닛 생산 슬롯과 내부 건설 대기열은 늘어나지 않는다. 같은 거리에서는 정착 거점 ID 오름차순으로 귀속하며 Farm·Mine·Blacksmith 본체만 한도에 포함하고 종속 확장과 군사 거점은 포함하지 않는다. 지원 관계는 저장하지 않고 현재 거점 상태에서 계산한다. 점령·발전·외곽 지구 적 점유로 한도를 초과해도 기존 생산 거점은 유지하며 한도 이하가 될 때까지 새 생산 거점 건설만 막는다.
