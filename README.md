...
min2world는 데스크톱 애플리케이션 개발자가 AI와 협업해 만들고 있는 싱글 플레이 웹 턴제 전략 시뮬레이션 게임입니다. AI를 활용한 개발 방법을 탐구하고, 멀티플랫폼 애플리케이션 개발에 필요한 React와 TypeScript 기반 웹 기술을 익히기 위한 학습·실험 프로젝트이기도 합니다.
